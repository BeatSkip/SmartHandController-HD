...
#define ONSTEP1_SSID             "Telescoop" //    "ONSTEP", Wifi alternate Station SSID to connnect to.                         Adjust
#define ONSTEP1_PASSWORD       "telescoop" //  "password", Wifi Station mode password.                                         Adjust
