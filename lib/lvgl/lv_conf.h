...
#define LV_MEM_CUSTOM 0
    ...
    /*Instead of an address give a memory allocator that will be called to get a memory pool for LVGL. E.g. my_malloc*/
        ...
        //#define LV_MEM_POOL_ALLOC heap_caps_malloc
    #endif
...
#endif     /*LV_MEM_CUSTOMLV_MEM_CUSTOM*/
...
#define LV_USE_FS_FATFS  0
    ...
    #define LV_FS_FATSF_CACHE_SIZE 128    /*>0 to cache this number of bytes in lv_fs_read()*/
#endif
